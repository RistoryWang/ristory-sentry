 ...
 * the EMER, BEAT, BIZ, DIAG, NOTICE and VERBOSE custom log levels.
 * <p>Compatible with Log4j 2.6 or higher.</p>
 */
public final class RSLogger extends ExtendedLoggerWrapper {
    private static final long serialVersionUID = 97965018674287L;
    private final ExtendedLoggerWrapper logger;

    private static final String FQCN = RSLogger.class.getName();
    public static final Level EMER = Level.forName("EMER", 150);
    public static final Level BEAT = Level.forName("BEAT", 230);
    public static final Level BIZ = Level.forName("BIZ", 270);
    ...
    private RSLogger(final Logger logger) {
     ...
     */
    public static RSLogger create() {
        final Logger wrapped = LogManager.getLogger();
        return new RSLogger(wrapped);
    }
     ...
     */
    public static RSLogger create(final Class<?> loggerName) {
     ...
     * @return The custom Logger.
     */
    public static RSLogger create(final Class<?> loggerName, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static RSLogger create(final Object value) {
     ...
     * @return The custom Logger.
     */
    public static RSLogger create(final Object value, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static RSLogger create(final String name) {
     ...
     * @return The custom Logger.
     */
    public static RSLogger create(final String name, final MessageFactory messageFactory) {
        final Logger wrapped = LogManager.getLogger(name, messageFactory);
        return new RSLogger(wrapped);
    }

    /**
     * Logs a message with the specific Marker at the {@code EMER} level.
     * 
     * @param marker the marker data specific to this log statement
     * @param msg the message string to be logged
     */
    public void emer(final Marker marker, final Message msg) {
        logger.logIfEnabled(FQCN, EMER, marker, msg, (Throwable) null);
    }
     ...
     */
    public void emer(final Marker marker, final Message msg, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, marker, msg, t);
    }

    /**
     * Logs a message object with the {@code EMER} level.
     * 
     * @param marker the marker data specific to this log statement
     * @param message the message object to log.
     */
    public void emer(final Marker marker, final Object message) {
        logger.logIfEnabled(FQCN, EMER, marker, message, (Throwable) null);
    }

    /**
     * Logs a message CharSequence with the {@code EMER} level.
     * 
     * @param marker the marker data specific to this log statement
     * @param message the message CharSequence to log.
     * @since Log4j-2.6
     */
    public void emer(final Marker marker, final CharSequence message) {
        logger.logIfEnabled(FQCN, EMER, marker, message, (Throwable) null);
    }

    /**
     * Logs a message at the {@code EMER} level including the stack trace of
     ...
     */
    public void emer(final Marker marker, final Object message, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, marker, message, t);
    }
     ...
     * @since Log4j-2.6
     */
    public void emer(final Marker marker, final CharSequence message, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, marker, message, t);
    }
     ...
     * @param message the message object to log.
     */
    public void emer(final Marker marker, final String message) {
        logger.logIfEnabled(FQCN, EMER, marker, message, (Throwable) null);
    }

    /**
     * Logs a message with parameters at the {@code EMER} level.
     * 
     * @param marker the marker data specific to this log statement
     ...
     */
    public void emer(final Marker marker, final String message, final Object... params) {
        logger.logIfEnabled(FQCN, EMER, marker, message, params);
    }
     ...
     * @since Log4j-2.6
     */
    public void emer(final Marker marker, final String message, final Object p0) {
        logger.logIfEnabled(FQCN, EMER, marker, message, p0);
    }
     ...
     * @since Log4j-2.6
     */
    public void emer(final Marker marker, final String message, final Object p0, final Object p1) {
        logger.logIfEnabled(FQCN, EMER, marker, message, p0, p1);
    }
     ...
     * @since Log4j-2.6
     */
    public void emer(final Marker marker, final String message, final Object p0, final Object p1, final Object p2) {
        logger.logIfEnabled(FQCN, EMER, marker, message, p0, p1, p2);
    }
    ...
    public void emer(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
            final Object p3) {
        logger.logIfEnabled(FQCN, EMER, marker, message, p0, p1, p2, p3);
    }
    ...
    public void emer(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
        ...
        logger.logIfEnabled(FQCN, EMER, marker, message, p0, p1, p2, p3, p4);
    }
    ...
    public void emer(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
        ...
        logger.logIfEnabled(FQCN, EMER, marker, message, p0, p1, p2, p3, p4, p5);
    }
    ...
    public void emer(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
        ...
        logger.logIfEnabled(FQCN, EMER, marker, message, p0, p1, p2, p3, p4, p5, p6);
    }
    ...
    public void emer(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6,
            final Object p7) {
        logger.logIfEnabled(FQCN, EMER, marker, message, p0, p1, p2, p3, p4, p5, p6, p7);
    }
    ...
    public void emer(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
        ...
        logger.logIfEnabled(FQCN, EMER, marker, message, p0, p1, p2, p3, p4, p5, p6, p7, p8);
    }
    ...
    public void emer(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
        ...
        logger.logIfEnabled(FQCN, EMER, marker, message, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9);
    }
     ...
     * @param t the exception to log, including its stack trace.
     */
    public void emer(final Marker marker, final String message, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, marker, message, t);
    }

    /**
     * Logs the specified Message at the {@code EMER} level.
     * 
     * @param msg the message string to be logged
     */
    public void emer(final Message msg) {
        logger.logIfEnabled(FQCN, EMER, null, msg, (Throwable) null);
    }
     ...
     * @param t A Throwable or null.
     */
    public void emer(final Message msg, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, null, msg, t);
    }
     ...
     * @param message the message object to log.
     */
    public void emer(final Object message) {
        logger.logIfEnabled(FQCN, EMER, null, message, (Throwable) null);
    }
     ...
     * @param t the exception to log, including its stack trace.
     */
    public void emer(final Object message, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, null, message, t);
    }
     ...
     * @since Log4j-2.6
     */
    public void emer(final CharSequence message) {
        logger.logIfEnabled(FQCN, EMER, null, message, (Throwable) null);
    }

    /**
     * Logs a CharSequence at the {@code EMER} level including the stack trace of
     * the {@link Throwable} {@code t} passed as parameter.
     * 
     * @param message the CharSequence to log.
     * @param t the exception to log, including its stack trace.
     * @since Log4j-2.6
     */
    public void emer(final CharSequence message, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, null, message, t);
    }
     ...
     * @param message the message object to log.
     */
    public void emer(final String message) {
        logger.logIfEnabled(FQCN, EMER, null, message, (Throwable) null);
    }
     ...
     * @see #getMessageFactory()
     */
    public void emer(final String message, final Object... params) {
        logger.logIfEnabled(FQCN, EMER, null, message, params);
    }
     ...
     * @since Log4j-2.6
     */
    public void emer(final String message, final Object p0) {
        logger.logIfEnabled(FQCN, EMER, null, message, p0);
    }
     ...
     * @since Log4j-2.6
     */
    public void emer(final String message, final Object p0, final Object p1) {
        logger.logIfEnabled(FQCN, EMER, null, message, p0, p1);
    }
     ...
     * @since Log4j-2.6
     */
    public void emer(final String message, final Object p0, final Object p1, final Object p2) {
        logger.logIfEnabled(FQCN, EMER, null, message, p0, p1, p2);
    }
    ...
    public void emer(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3) {
        logger.logIfEnabled(FQCN, EMER, null, message, p0, p1, p2, p3);
    }
    ...
    public void emer(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4) {
        logger.logIfEnabled(FQCN, EMER, null, message, p0, p1, p2, p3, p4);
    }
    ...
    public void emer(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5) {
        logger.logIfEnabled(FQCN, EMER, null, message, p0, p1, p2, p3, p4, p5);
    }
    ...
    public void emer(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6) {
        logger.logIfEnabled(FQCN, EMER, null, message, p0, p1, p2, p3, p4, p5, p6);
    }
    ...
    public void emer(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6,
            final Object p7) {
        logger.logIfEnabled(FQCN, EMER, null, message, p0, p1, p2, p3, p4, p5, p6, p7);
    }
    ...
    public void emer(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6,
            final Object p7, final Object p8) {
        logger.logIfEnabled(FQCN, EMER, null, message, p0, p1, p2, p3, p4, p5, p6, p7, p8);
    }
    ...
    public void emer(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6,
            final Object p7, final Object p8, final Object p9) {
        logger.logIfEnabled(FQCN, EMER, null, message, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9);
    }
     ...
     * @param t the exception to log, including its stack trace.
     */
    public void emer(final String message, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, null, message, t);
    }

    /**
     * Logs a message which is only to be constructed if the logging level is the {@code EMER}level.
     *
     * @param msgSupplier A function, which when called, produces the desired log message;
     *            the format depends on the message factory.
     * @since Log4j-2.4
     */
    public void emer(final Supplier<?> msgSupplier) {
        logger.logIfEnabled(FQCN, EMER, null, msgSupplier, (Throwable) null);
    }

    /**
     * Logs a message (only to be constructed if the logging level is the {@code EMER}
     ...
     * @since Log4j-2.4
     */
    public void emer(final Supplier<?> msgSupplier, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, null, msgSupplier, t);
    }

    /**
     * Logs a message which is only to be constructed if the logging level is the
     * {@code EMER} level with the specified Marker.
     *
     * @param marker the marker data specific to this log statement
     * @param msgSupplier A function, which when called, produces the desired log message;
     *            the format depends on the message factory.
     * @since Log4j-2.4
     */
    public void emer(final Marker marker, final Supplier<?> msgSupplier) {
        logger.logIfEnabled(FQCN, EMER, marker, msgSupplier, (Throwable) null);
    }
     ...
     * @since Log4j-2.4
     */
    public void emer(final Marker marker, final String message, final Supplier<?>... paramSuppliers) {
        logger.logIfEnabled(FQCN, EMER, marker, message, paramSuppliers);
    }
     ...
     * @since Log4j-2.4
     */
    public void emer(final Marker marker, final Supplier<?> msgSupplier, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, marker, msgSupplier, t);
    }
     ...
     * @since Log4j-2.4
     */
    public void emer(final String message, final Supplier<?>... paramSuppliers) {
        logger.logIfEnabled(FQCN, EMER, null, message, paramSuppliers);
    }

    /**
     * Logs a message which is only to be constructed if the logging level is the
     * {@code EMER} level with the specified Marker. The {@code MessageSupplier} may or may
     ...
     * @since Log4j-2.4
     */
    public void emer(final Marker marker, final MessageSupplier msgSupplier) {
        logger.logIfEnabled(FQCN, EMER, marker, msgSupplier, (Throwable) null);
    }
     ...
     * @since Log4j-2.4
     */
    public void emer(final Marker marker, final MessageSupplier msgSupplier, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, marker, msgSupplier, t);
    }

    /**
     * Logs a message which is only to be constructed if the logging level is the
     * {@code EMER} level. The {@code MessageSupplier} may or may not use the
     * {@link MessageFactory} to construct the {@code Message}.
     *
     * @param msgSupplier A function, which when called, produces the desired log message.
     * @since Log4j-2.4
     */
    public void emer(final MessageSupplier msgSupplier) {
        logger.logIfEnabled(FQCN, EMER, null, msgSupplier, (Throwable) null);
    }
     ...
     * @since Log4j-2.4
     */
    public void emer(final MessageSupplier msgSupplier, final Throwable t) {
        logger.logIfEnabled(FQCN, EMER, null, msgSupplier, t);
    }

    /**
     * Logs a message with the specific Marker at the {@code BEAT} level.
     * 
     * @param marker the marker data specific to this log statement
     * @param msg the message string to be logged
     */
    public void beat(final Marker marker, final Message msg) {
        logger.logIfEnabled(FQCN, BEAT, marker, msg, (Throwable) null);
    }
     ...
     * @param t A Throwable or null.
     */
    public void beat(final Marker marker, final Message msg, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, marker, msg, t);
    }

    /**
     * Logs a message object with the {@code BEAT} level.
     * 
     * @param marker the marker data specific to this log statement
     * @param message the message object to log.
     */
    public void beat(final Marker marker, final Object message) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, (Throwable) null);
    }

    /**
     * Logs a message CharSequence with the {@code BEAT} level.
     * 
     * @param marker the marker data specific to this log statement
     * @param message the message CharSequence to log.
     * @since Log4j-2.6
     */
    public void beat(final Marker marker, final CharSequence message) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, (Throwable) null);
    }

    /**
     * Logs a message at the {@code BEAT} level including the stack trace of
     * the {@link Throwable} {@code t} passed as parameter.
     * 
     * @param marker the marker data specific to this log statement
     * @param message the message to log.
     * @param t the exception to log, including its stack trace.
     */
    public void beat(final Marker marker, final Object message, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, t);
    }
     ...
     * @since Log4j-2.6
     */
    public void beat(final Marker marker, final CharSequence message, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, t);
    }
     ...
     * @param message the message object to log.
     */
    public void beat(final Marker marker, final String message) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, (Throwable) null);
    }

    /**
     * Logs a message with parameters at the {@code BEAT} level.
     * 
     * @param marker the marker data specific to this log statement
     * @param message the message to log; the format depends on the message factory.
     * @param params parameters to the message.
     * @see #getMessageFactory()
     */
    public void beat(final Marker marker, final String message, final Object... params) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, params);
    }
     ...
     * @since Log4j-2.6
     */
    public void beat(final Marker marker, final String message, final Object p0) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, p0);
    }
     ...
     * @since Log4j-2.6
     */
    public void beat(final Marker marker, final String message, final Object p0, final Object p1) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, p0, p1);
    }
     ...
     * @since Log4j-2.6
     */
    public void beat(final Marker marker, final String message, final Object p0, final Object p1, final Object p2) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, p0, p1, p2);
    }
    ...
    public void beat(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
            final Object p3) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, p0, p1, p2, p3);
    }
    ...
    public void beat(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, p0, p1, p2, p3, p4);
    }
    ...
    public void beat(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, p0, p1, p2, p3, p4, p5);
    }
    ...
    public void beat(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, p0, p1, p2, p3, p4, p5, p6);
    }
    ...
    public void beat(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6,
            final Object p7) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, p0, p1, p2, p3, p4, p5, p6, p7);
    }
    ...
    public void beat(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6,
            final Object p7, final Object p8) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, p0, p1, p2, p3, p4, p5, p6, p7, p8);
    }
    ...
    public void beat(final Marker marker, final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6,
            final Object p7, final Object p8, final Object p9) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9);
    }
     ...
     * @param t the exception to log, including its stack trace.
     */
    public void beat(final Marker marker, final String message, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, t);
    }

    /**
     * Logs the specified Message at the {@code BEAT} level.
     * 
     * @param msg the message string to be logged
     */
    public void beat(final Message msg) {
        logger.logIfEnabled(FQCN, BEAT, null, msg, (Throwable) null);
    }
     ...
     * @param t A Throwable or null.
     */
    public void beat(final Message msg, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, null, msg, t);
    }
     ...
     * @param message the message object to log.
     */
    public void beat(final Object message) {
        logger.logIfEnabled(FQCN, BEAT, null, message, (Throwable) null);
    }
     ...
     * @param t the exception to log, including its stack trace.
     */
    public void beat(final Object message, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, null, message, t);
    }
     ...
     * @since Log4j-2.6
     */
    public void beat(final CharSequence message) {
        logger.logIfEnabled(FQCN, BEAT, null, message, (Throwable) null);
    }

    /**
     * Logs a CharSequence at the {@code BEAT} level including the stack trace of
     * the {@link Throwable} {@code t} passed as parameter.
     * 
     * @param message the CharSequence to log.
     * @param t the exception to log, including its stack trace.
     * @since Log4j-2.6
     */
    public void beat(final CharSequence message, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, null, message, t);
    }
     ...
     * @param message the message object to log.
     */
    public void beat(final String message) {
        logger.logIfEnabled(FQCN, BEAT, null, message, (Throwable) null);
    }
     ...
     * @see #getMessageFactory()
     */
    public void beat(final String message, final Object... params) {
        logger.logIfEnabled(FQCN, BEAT, null, message, params);
    }
     ...
     * @since Log4j-2.6
     */
    public void beat(final String message, final Object p0) {
        logger.logIfEnabled(FQCN, BEAT, null, message, p0);
    }
     ...
     * @since Log4j-2.6
     */
    public void beat(final String message, final Object p0, final Object p1) {
        logger.logIfEnabled(FQCN, BEAT, null, message, p0, p1);
    }
     ...
     * @since Log4j-2.6
     */
    public void beat(final String message, final Object p0, final Object p1, final Object p2) {
        logger.logIfEnabled(FQCN, BEAT, null, message, p0, p1, p2);
    }
    ...
    public void beat(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3) {
        logger.logIfEnabled(FQCN, BEAT, null, message, p0, p1, p2, p3);
    }
    ...
    public void beat(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4) {
        logger.logIfEnabled(FQCN, BEAT, null, message, p0, p1, p2, p3, p4);
    }
    ...
    public void beat(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5) {
        logger.logIfEnabled(FQCN, BEAT, null, message, p0, p1, p2, p3, p4, p5);
    }
    ...
    public void beat(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6) {
        logger.logIfEnabled(FQCN, BEAT, null, message, p0, p1, p2, p3, p4, p5, p6);
    }
    ...
    public void beat(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6,
            final Object p7) {
        logger.logIfEnabled(FQCN, BEAT, null, message, p0, p1, p2, p3, p4, p5, p6, p7);
    }
    ...
    public void beat(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6,
            final Object p7, final Object p8) {
        logger.logIfEnabled(FQCN, BEAT, null, message, p0, p1, p2, p3, p4, p5, p6, p7, p8);
    }
    ...
    public void beat(final String message, final Object p0, final Object p1, final Object p2,
            final Object p3, final Object p4, final Object p5, final Object p6,
            final Object p7, final Object p8, final Object p9) {
        logger.logIfEnabled(FQCN, BEAT, null, message, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9);
    }
     ...
     * @param t the exception to log, including its stack trace.
     */
    public void beat(final String message, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, null, message, t);
    }

    /**
     * Logs a message which is only to be constructed if the logging level is the {@code BEAT}level.
     *
     * @param msgSupplier A function, which when called, produces the desired log message;
     *            the format depends on the message factory.
     * @since Log4j-2.4
     */
    public void beat(final Supplier<?> msgSupplier) {
        logger.logIfEnabled(FQCN, BEAT, null, msgSupplier, (Throwable) null);
    }

    /**
     * Logs a message (only to be constructed if the logging level is the {@code BEAT}
     * level) including the stack trace of the {@link Throwable} <code>t</code> passed as parameter.
     *
     * @param msgSupplier A function, which when called, produces the desired log message;
     *            the format depends on the message factory.
     ...
     * @since Log4j-2.4
     */
    public void beat(final Supplier<?> msgSupplier, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, null, msgSupplier, t);
    }

    /**
     * Logs a message which is only to be constructed if the logging level is the
     * {@code BEAT} level with the specified Marker.
     *
     * @param marker the marker data specific to this log statement
     * @param msgSupplier A function, which when called, produces the desired log message;
     *            the format depends on the message factory.
     * @since Log4j-2.4
     */
    public void beat(final Marker marker, final Supplier<?> msgSupplier) {
        logger.logIfEnabled(FQCN, BEAT, marker, msgSupplier, (Throwable) null);
    }
     ...
     * @since Log4j-2.4
     */
    public void beat(final Marker marker, final String message, final Supplier<?>... paramSuppliers) {
        logger.logIfEnabled(FQCN, BEAT, marker, message, paramSuppliers);
    }
     ...
     * @since Log4j-2.4
     */
    public void beat(final Marker marker, final Supplier<?> msgSupplier, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, marker, msgSupplier, t);
    }
     ...
     * @since Log4j-2.4
     */
    public void beat(final String message, final Supplier<?>... paramSuppliers) {
        logger.logIfEnabled(FQCN, BEAT, null, message, paramSuppliers);
    }

    /**
     * Logs a message which is only to be constructed if the logging level is the
     * {@code BEAT} level with the specified Marker. The {@code MessageSupplier} may or may
     * not use the {@link MessageFactory} to construct the {@code Message}.
     *
     * @param marker the marker data specific to this log statement
     * @param msgSupplier A function, which when called, produces the desired log message.
     * @since Log4j-2.4
     */
    public void beat(final Marker marker, final MessageSupplier msgSupplier) {
        logger.logIfEnabled(FQCN, BEAT, marker, msgSupplier, (Throwable) null);
    }
     ...
     * @since Log4j-2.4
     */
    public void beat(final Marker marker, final MessageSupplier msgSupplier, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, marker, msgSupplier, t);
    }

    /**
     * Logs a message which is only to be constructed if the logging level is the
     * {@code BEAT} level. The {@code MessageSupplier} may or may not use the
     * {@link MessageFactory} to construct the {@code Message}.
     *
     * @param msgSupplier A function, which when called, produces the desired log message.
     * @since Log4j-2.4
     */
    public void beat(final MessageSupplier msgSupplier) {
        logger.logIfEnabled(FQCN, BEAT, null, msgSupplier, (Throwable) null);
    }
     ...
     * @since Log4j-2.4
     */
    public void beat(final MessageSupplier msgSupplier, final Throwable t) {
        logger.logIfEnabled(FQCN, BEAT, null, msgSupplier, t);
    }
    ...
    public void bizMdc(final String msg,final int type) {

        ThreadContext.put("type", String.valueOf(type));
        logger.logIfEnabled(FQCN, BIZ, null, msg, (Throwable) null);
        ThreadContext.remove("type");

    }

//    public void bizMdc(final String msg,final String mdcInfo) {
//
//        JSONObject jsonObj = JSON.parseObject(mdcInfo);
//        for (Map.Entry<String, Object> entry : jsonObj.entrySet()) {
//            ThreadContext.put(entry.getKey(), entry.getKey());
//        }
//        logger.logIfEnabled(FQCN, BIZ, null, msg, (Throwable) null);
//        for (Map.Entry<String, Object> entry : jsonObj.entrySet()) {
