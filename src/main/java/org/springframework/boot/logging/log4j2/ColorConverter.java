...
import com.ristory.sentry.PGLogger;
...
//                WHITE("37"),
        ...
        ansiLevels.put(Level.FATAL.intLevel(), AnsiColor.RED);
        ansiLevels.put(PGLogger.EMER.intLevel(), AnsiColor.RED);
        ansiLevels.put(Level.ERROR.intLevel(), AnsiColor.MAGENTA);
        ansiLevels.put(PGLogger.BEAT.intLevel(), AnsiColor.WHITE);
        ansiLevels.put(PGLogger.BIZ.intLevel(), AnsiColor.CYAN);
        ansiLevels.put(Level.WARN.intLevel(), AnsiColor.YELLOW);
        ansiLevels.put(PGLogger.DIAG.intLevel(), AnsiColor.YELLOW);
        ansiLevels.put(Level.INFO.intLevel(), AnsiColor.GREEN);
        ansiLevels.put(PGLogger.NOTICE.intLevel(), AnsiColor.GREEN);
        ansiLevels.put(Level.DEBUG.intLevel(), AnsiColor.WHITE);
        ansiLevels.put(PGLogger.VERBOSE.intLevel(), AnsiColor.WHITE);
        ansiLevels.put(Level.TRACE.intLevel(), AnsiColor.WHITE);
