...
import static io.sentry.event.Event.Level.*;
...
public class SentryAppender extends AbstractAppender {
    ...
    protected static Event.Level formatLevel(Level level) {
        ...
        } else if (level.isMoreSpecificThan(PGLogger.EMER)) {
            return EMER;
        } else if (level.isMoreSpecificThan(Level.ERROR)) {
            return Event.Level.ERROR;
        } else if (level.isMoreSpecificThan(PGLogger.BEAT)) {
            return BEAT;
        } else if (level.isMoreSpecificThan(PGLogger.BIZ)) {
            return BIZ;
        } else if (level.isMoreSpecificThan(Level.WARN)) {
            return Event.Level.WARNING;
        } else if (level.isMoreSpecificThan(PGLogger.DIAG)) {
            return DIAG;
        } else if (level.isMoreSpecificThan(Level.INFO)) {
            return Event.Level.INFO;
        } else if (level.isMoreSpecificThan(PGLogger.NOTICE)) {
            return NOTICE;
